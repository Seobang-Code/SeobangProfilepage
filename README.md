...
코팅까지 마무리 된 제품의 최종 결함을 검사하는 설비 <br>
  ...
  - **Project 2 : 부적합 스테이션 세분화**
    ...
    목표 : 제품 검사시 치수/외관 불량에 대해 세분화하여 분류 적재할 수 있도록 프로그램 개선 및 현장 설비 업데이트.

    주요 역할 :
     - 부적합 제품에 대해 세부적 구분이 불가능 했던 부적합 스테이션을 치수/외관 부적합으로
   
  - **Project 3 : 구형 설비 업그레이드**

    목표 : 고객사 니즈에 맞게 설비 업그레이드 및 설치 셋업 .

    주요 역할 :
     - 기존 검사 설비 내 컨베이어 파트 스탭 모터에서 서보 모터로 변경에 따른 코드 업데이트.
     - 부적합 제품에 대해 세부적 구분이 불가능 했던 부적합 스테이션을 치수/외관 부적합으로
