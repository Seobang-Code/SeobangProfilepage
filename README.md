...
### 👨Introduction
안녕하세요.<br>
C#, .Net Framework를 사용하여 Windows PC 기반 로봇 제어 자동화 시스템 소프트웨어의 개발 및 개선을 담당한 엔지니어 개발자입니다.
...
코팅까지 마무리 된 제품의 최종 결함을 검사하는 설비 <br>
  ...
  - **Project 2 : 부적합 스테이션 세분화**
    ...
    주요 역할 :
     - 기존 코드에서 부적합 제품을 세분화하여 구분할 수 있도록 부적합 스테이션의 팔레트 공간을 비율에 따라 설정하여 세분화된 분류 및 적재 기능을 구현.
     - 스테이션 세분화에 맞춰 UI를 개선하고, 고객사의 요청에 따라 가독성을 향상시키는 추가 작업을 수행.
  ...
  - **Project 4 : 설비 설정 위치 자동 이동 기능 추가**

    목표 : 비전/검사팀의 작업 및 테스트 효율성을 높이기 위한 자동 위치 이동 기능 개발.

    주요 역할 :
     - 선택한 위치의 초점 타겟을 자동으로 정위치(스테이션)에 복귀시키는 기능을 추가하여 작업 편의성 향상.
     - 각 축을 안전하게 자동 정렬 및 이동하여, 스테이지별 이미지 취득을 위한 위치 설정 기능을 개발.
     - SharedMemory 통신 코드 내에서 발생한 버그를 비전/검사팀과 협력하여 수정하고, 시스템의 안정성을 개선.
<br>
